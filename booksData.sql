CREATE DATABASE  IF NOT EXISTS `books-data` /*!40100 DEFAULT CHARACTER SET utf8mb3 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `books-data`;
-- MySQL dump 10.13  Distrib 8.0.34, for Win64 (x86_64)
--
-- Host: localhost    Database: books-data
-- ------------------------------------------------------
...
-- Dump completed on 2023-10-29 22:20:34
